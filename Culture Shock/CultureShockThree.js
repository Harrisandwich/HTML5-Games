...
var adjHeight = window.innerHeight - (window.innerHeight * 0.08);
var scene = new THREE.Scene();
var camera = new THREE.PerspectiveCamera( 75, window.innerWidth/adjHeight, 0.1, 1000 );
...
renderer.setSize( window.innerWidth, adjHeight );
document.body.appendChild( renderer.domElement );
$('canvas').attr("id", "threeCanvas");

var geometry = new THREE.SphereGeometry(1,32,32,0,6.3,0,6.3);
...
$('#threeCanvas').bind('mousedown',getMouseStart);
$('#threeCanvas').bind('mousemove',mouseIsMoving);
$('#threeCanvas').bind('mouseup',mouseEnd);
