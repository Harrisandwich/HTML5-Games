...
var cultureControls = "<select onchange='setColour(value)' id='colourSelect'> <option value='blue'>Blue</option> <option value='red'>Red</option> <option value='green'>Green</option> </select><br/><br/> <select onchange='changeScreen(value)' id='screenSelect'> <option value='square'>Square</option> <option value='full'>Full Screen</option> </select><br/><br/> <select onchange='changeType(value)' id='modeSelect'> <option value='normal'>Normal</option> <option value='domination'>Domination</option> </select><br/><br/> <input type='button' value='Pause' id='pauseButton'/> <input type='button' value='Clear' id='clearButton' onclick='clearNodes()'/><br/><br/> <input type='checkbox' name='showIds' value='show' onchange='toggleIds(checked)'/>Show IDs <input type='range' name='speed' value=1 min=1 max=10 onchange='setSpeed(value)'/><br/><br/>Speed:<div id='speedLabel' style='display:inline;'></div>"
